...
module.exports = (sequelize, DataTypes) => {
  const TelegramConfig = sequelize.define(
    "TelegramConfig",
    {
      ...
      alert_shop_new_order: { type: DataTypes.BOOLEAN, allowNull: false, defaultValue: true },
      alert_shop_new_reservation: { type: DataTypes.BOOLEAN, allowNull: false, defaultValue: true },
